        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <ul class="list-unstyled footer-link">
              <li><span class="mr-3 d-block">Adresse :</span><span class="text-white">34 rue de la paix, Lille, France</span></li>
              <li><span class="mr-3 d-block">Téléphone :</span><span class="text-white">08 25 12 89 85</span></li>
              <li><span class="mr-3 d-block">E-mail :</span><span class="text-white">contact@marieteam.com</span></li>
            </ul>
          </div>
          <div class="col-md-3">
            ...
            <ul class="list-unstyled footer-link">
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="mentions_legales">Mentions légales</h5>
              ...
              <div class="modal fade" id="protection_des_donnees" tabindex="-1" role="dialog" aria-labelledby="protection_des_donnees" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="protection_des_donnees">Protection des données</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
              ...
              <div class="modal fade" id="conditions_generales_de_vente" tabindex="-1" role="dialog" aria-labelledby="conditions_generales_de_vente" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="conditions_generales_de_vente">Conditions Générales de Vente</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">&times;</span>
                        </button>
                      </div>
